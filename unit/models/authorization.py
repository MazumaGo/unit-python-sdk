...
class AuthorizationDTO(object):
    ...
    def from_json_api(_id, _type, attributes, relationships):
        return AuthorizationDTO(
            ...
            attributes["merchant"]["type"],
            attributes["merchant"]["category"],
            attributes["merchant"].get("location"),
            attributes["recurring"],
            attributes.get("paymentMethod"),
            attributes.get("digitalWallet"),
            attributes.get("cardVerificationData"),
            attributes.get("cardNetwork"),
            attributes.get("tags"),
            relationships,
            attributes["merchant"].get("id"),
        )
...
class ListAuthorizationParams(UnitParams):
    def __init__(
        ...
        include_non_authorized: Optional[bool] = False,
