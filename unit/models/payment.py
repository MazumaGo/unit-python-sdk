...
PaymentStatus = Literal[
    "Pending", "Rejected", "Clearing", "Sent", "Canceled", "Returned"
]
...
class AchPaymentDTO(BasePayment):
    ...
    def from_json_api(_id, _type, attributes, relationships):
        return AchPaymentDTO(
            ...
            attributes["amount"],
            attributes.get("addenda"),
            attributes.get("reason"),
            date_utils.to_date(attributes.get("settlementDate")),
            attributes.get("tags"),
            relationships,
        )
...
class WirePaymentDTO(BasePayment):
    ...
    @staticmethod
    def from_json_api(_id, _type, attributes, relationships):
        return WirePaymentDTO(
            _id,
            date_utils.to_datetime(attributes["createdAt"]),
            attributes["status"],
            WireCounterparty.from_json_api(attributes["counterparty"]),
            attributes["direction"],
            attributes["description"],
            attributes["amount"],
            attributes.get("reason"),
...
class CreateInlinePaymentRequest(CreatePaymentBaseRequest):
    def __init__(
        ...
        CreatePaymentBaseRequest.__init__(
            self, amount, description, relationships, idempotency_key, tags, direction
        )
...
class CreateLinkedPaymentRequest(CreatePaymentBaseRequest):
    def __init__(
        ...
        relationships: Dict[str, Relationship],
        addenda: Optional[str],
        verify_counterparty_balance: Optional[bool],
        idempotency_key: Optional[str],
        tags: Optional[Dict[str, str]],
        direction: str = "Credit",
    ):
    ...
    def to_json_api(self) -> Dict:
        ...
        if self.verify_counterparty_balance:
            ...
            ] = self.verify_counterparty_balance
...
class SimulateIncomingAchRequest(CreatePaymentBaseRequest):
    def __init__(
        ...
        CreatePaymentBaseRequest.__init__(
            self, amount, description, relationships, None, None, direction
        )
...
class CreateVerifiedPaymentRequest(CreatePaymentBaseRequest):
    def __init__(
        ...
        CreatePaymentBaseRequest.__init__(
            self, amount, description, relationships, idempotency_key, tags
        )
...
class PatchAchPaymentRequest(object):
    ...
    def to_json_api(self) -> Dict:
        payload = {"data": {"type": "achPayment", "attributes": {"tags": self.tags}}}
...
class PatchBookPaymentRequest(object):
    ...
    def to_json_api(self) -> Dict:
        payload = {"data": {"type": "bookPayment", "attributes": {"tags": self.tags}}}
...
class ListPaymentParams(UnitParams):
    def __init__(
        ...
        type: Optional[List[PaymentTypes]] = None,
        direction: Optional[List[PaymentDirections]] = None,
